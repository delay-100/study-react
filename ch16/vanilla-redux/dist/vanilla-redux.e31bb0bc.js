...
var DECREASE = "DECREASE"; // 액션 함수 생성: 액션 이름을 사용하여 액션 객체를 만듦
...
var store = (0, _redux.createStore)(reducer); // 함수의 파라미터에 리듀서를 넣어줘야 함
...
render(); // 구독하기: 스토어의 상태가 바뀔 때마다 방금 만든 render 함수가 호출되도록 해줌(스토어 내장함수 subscribe 사용)
// subscribe 함수의 파라미터로는 함수 형태의 값을 전달함. 전달된 함수는 추후 액션이 발생하여 상태가 업데이트 될 때마다 호출됨

store.subscribe(render); // 디스패치: 액션을 발생시키는 것(스토어 내장함수 dispatch 사용)
...
},{"redux":"node_modules/redux/es/redux.js"}],"C:/Users/백지연/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
...
},{}]},{},["C:/Users/백지연/AppData/Roaming/npm/node_modules/parcel-bundler/src/builtins/hmr-runtime.js","index.js"], null)
